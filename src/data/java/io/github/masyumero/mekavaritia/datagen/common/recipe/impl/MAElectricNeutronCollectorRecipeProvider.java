...
public class MAElectricNeutronCollectorRecipeProvider implements ISubRecipeProvider {
    ...
    public void addRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ElectricNeutronCollectorRecipeBuilder.neutronCollector(
                ...
                40
        ).build(consumer, MAUtils.rl(basePath + "prismatic/neutron_pile"));
        ...
        ElectricNeutronCollectorRecipeBuilder.neutronCollector(
                ...
                20
        ).build(consumer, MAUtils.rl(basePath + "flare/neutron_pile"));
        ...
        ElectricNeutronCollectorRecipeBuilder.neutronCollector(
                ...
                10
        ).build(consumer, MAUtils.rl(basePath + "neural/neutron_pile"));
        ...
        ElectricNeutronCollectorRecipeBuilder.neutronCollector(
                ...
                1
        ).build(consumer, MAUtils.rl(basePath + "eternal/neutron_pile"));
    }
}
