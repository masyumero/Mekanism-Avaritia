...
public final class MABlockShapes {
    ...
    static {
        VoxelShapeUtils.setShape(VoxelShapeUtils.rotate(VoxelShapeUtils.combine(
                box(12, 0, 14.02,16, 4, 16.02),
                box(4, 0, 14.02,12, 4, 16.02),
                box(4, 4, 13.52,12, 12, 14.02),
                box(0, 0, 14.02,4, 4, 16.02),
                box(0, 0, 14.02,4, 4, 16.02),
                box(0, 12, 14.02,16, 16, 16.02),
                box(0, 0, 0.02,16, 7, 14.02),
                box(13, 7, 0.02,16, 9, 14.02),
                box(3, 7, 0.52,13, 9, 15.02),
                box(4, 4, 16,12, 12, 16),
                box(4, 4, 14,12, 12, 16),
                box(3, 7, 0.02,13, 9, 0.52),
                box(0, 7, 0.02,3, 9, 14.02),
                box(0, 9, 0.02,16, 16, 14.02)
