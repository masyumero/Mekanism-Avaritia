package io.github.masyumero.mekanismavaritia.common.item.block;
...
public class MAItemBlockTooltip<BLOCK extends Block & IHasDescription> extends ItemBlockMA<BLOCK> {

    private final boolean hasDetails;

    public MAItemBlockTooltip(BLOCK block, Item.Properties properties) {
        this(block, false, properties);
    }

    public MAItemBlockTooltip(BLOCK block) {
        this(block, true, new Item.Properties().stacksTo(1));
    }

    protected MAItemBlockTooltip(BLOCK block, boolean hasDetails, Properties properties) {
