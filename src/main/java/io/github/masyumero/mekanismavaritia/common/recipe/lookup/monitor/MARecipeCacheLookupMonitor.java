package io.github.masyumero.mekanismavaritia.common.recipe.lookup.monitor;

import io.github.masyumero.mekanismavaritia.common.recipe.lookup.IMARecipeLookupHandler;
...
public class MARecipeCacheLookupMonitor<RECIPE extends MekanismRecipe> implements ICachedRecipeHolder<RECIPE>, IContentsListener {
    private final IMARecipeLookupHandler<RECIPE> handler;
    protected final int cacheIndex;
    protected CachedRecipe<RECIPE> cachedRecipe;
    protected boolean hasNoRecipe;

    public MARecipeCacheLookupMonitor(IMARecipeLookupHandler<RECIPE> handler) {
        this(handler, 0);
    }

    public MARecipeCacheLookupMonitor(IMARecipeLookupHandler<RECIPE> handler, int cacheIndex) {
