...
public class MASingularities {
    public static final Singularity CRYSTALLINE_ALLOY = new Singularity(new ResourceLocation(MekanismAvaritia.MODID, "crystalline_alloy"), MekanismAvaritiaLang.CRYSTALLINE_ALLOY_SINGULARITY.getTranslationKey(), new int[]{0x6fb0ac, 0x134340}, Ingredient.of(MAItems.CRYSTALLINE_ALLOY));
