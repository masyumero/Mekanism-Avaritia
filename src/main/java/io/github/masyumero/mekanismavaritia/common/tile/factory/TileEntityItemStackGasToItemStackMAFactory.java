...
public class TileEntityItemStackGasToItemStackMAFactory extends TileEntityItemToItemMAFactory<ItemStackGasToItemStackRecipe> implements IHasDumpButton,
    ...
    public TileEntityItemStackGasToItemStackMAFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
        ...
        if (useStatisticalMechanics()) {
            ...
            gasUsageMultiplier = (usedSoFar, operatingTicks) -> {
                ...
                int remainingTicks = type == MAFactoryType.COMPRESSING ? 1 : getTicksRequired() - operatingTicks;
    ...
    private boolean allowExtractingChemical() {
        ...
        return Attribute.get(blockProvider, MAAttributeFactoryType.class).getFactoryType() == MAFactoryType.COMPRESSING;
    }

    private boolean useStatisticalMechanics() {
        return type == MAFactoryType.INJECTING || type == MAFactoryType.PURIFYING;
    }
