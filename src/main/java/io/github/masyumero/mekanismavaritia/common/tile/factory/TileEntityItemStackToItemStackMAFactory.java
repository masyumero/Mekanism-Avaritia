...
public class TileEntityItemStackToItemStackMAFactory extends TileEntityItemToItemMAFactory<ItemStackToItemStackRecipe> implements
    ...
    public TileEntityItemStackToItemStackMAFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
