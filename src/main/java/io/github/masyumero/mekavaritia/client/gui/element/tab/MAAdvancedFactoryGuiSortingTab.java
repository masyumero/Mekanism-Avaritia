...
public class MAAdvancedFactoryGuiSortingTab extends GuiInsetElement<TileEntityMAAdvancedFactoryBase<?>> {

    public MAAdvancedFactoryGuiSortingTab(IGuiWrapper gui, TileEntityMAAdvancedFactoryBase<?> tile) {
