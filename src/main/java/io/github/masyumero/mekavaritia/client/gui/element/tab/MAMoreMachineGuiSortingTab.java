...
public class MAMoreMachineGuiSortingTab extends GuiInsetElement<TileEntityMAMoreMachineFactory<?>> {

    public MAMoreMachineGuiSortingTab(IGuiWrapper gui, TileEntityMAMoreMachineFactory<?> tile) {
