...
public class RenderMAMechanicalPipe extends RenderTransmitterBase<TileEntityMAMechanicalPipe> {
    ...
    public RenderMAMechanicalPipe(BlockEntityRendererProvider.Context context) {
        super(context);
    }
    ...
    @Override
    protected void render(TileEntityMAMechanicalPipe tile, float partialTick, PoseStack matrix, MultiBufferSource renderer, int light, int overlayLight,
    ...
    @Override
    protected boolean shouldRenderTransmitter(TileEntityMAMechanicalPipe tile, Vec3 camera) {
