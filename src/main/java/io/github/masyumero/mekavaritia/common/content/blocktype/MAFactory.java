...
public class MAFactory<TILE extends TileEntityMAFactory<?>> extends MAMachine.MAFactoryMachine<TILE> {
    ...
    public static class MAFactoryBuilder<FACTORY extends MAFactory<TILE>, TILE extends TileEntityMAFactory<?>, T extends MAMachine.MAMachineBuilder<FACTORY, TILE, T>>
        ...
        public static <TILE extends TileEntityMAFactory<?>> MAFactoryBuilder<MAFactory<TILE>, TILE, ?> createFactory(Supplier<?> tileEntityRegistrar, FactoryType type,
                                                                                                                               MAFactoryTier tier) {
...
//            });
    ...
    private static <TILE extends TileEntityMAFactory<?>> @NotNull MAFactoryBuilder<MAFactory<TILE>, TILE, ?> getEMFactoryTILEEMFactoryBuilder(Supplier<TileEntityTypeRegistryObject<TILE>> tileEntityRegistrar, FactoryType type, MAFactoryTier tier) {
