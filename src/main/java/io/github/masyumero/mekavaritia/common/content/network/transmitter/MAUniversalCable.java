...
public class MAUniversalCable extends UniversalCable implements IMAUpgradeableTransmitter<UniversalCableUpgradeData> {

    public MAUniversalCable(IBlockProvider blockProvider, TileEntityTransmitter tile) {
    ...
    public FloatingLong getCapacityAsFloatingLong() {
        return MACTier.getCapacityAsFloatingLong(tier);
    }
