...
public class TileEntityMACentrifugingFactory extends TileEntityMAGasToGasFactory<GasToGasRecipe> implements IBoundingBlock, ChemicalRecipeLookupHandler<Gas, GasStack, GasToGasRecipe> {
    ...
    public TileEntityMACentrifugingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
