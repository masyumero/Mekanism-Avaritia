...
import io.github.masyumero.mekavaritia.common.integration.mekaf.tile.factory.base.TileEntityMAMergedToItemFactory;
...
public class TileEntityMACrystallizingFactory extends TileEntityMAMergedToItemFactory<ChemicalCrystallizerRecipe> {
    ...
    public TileEntityMACrystallizingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
