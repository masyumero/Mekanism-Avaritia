...
import io.github.masyumero.mekavaritia.common.integration.mekaf.tile.factory.base.TileEntityMAItemToFluidFactory;
...
public class TileEntityMALiquifyingFactory extends TileEntityMAItemToFluidFactory<ItemStackToFluidRecipe> {
    ...
    public TileEntityMALiquifyingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
