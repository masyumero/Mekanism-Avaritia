...
import io.github.masyumero.mekavaritia.common.integration.mekaf.tile.factory.base.TileEntityMAItemToGasFactory;
...
public class TileEntityMAOxidizingFactory extends TileEntityMAItemToGasFactory<ItemStackToGasRecipe> implements ItemRecipeLookupHandler<ItemStackToGasRecipe> {
    ...
    public TileEntityMAOxidizingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
