...
public class TileEntityMAPaintingFactory extends TileEntityMAItemToItemAdvancedFactory<PaintingRecipe> implements ItemChemicalRecipeLookupHandler<Pigment, PigmentStack, PaintingRecipe>, IHasDumpButton {
    ...
    public TileEntityMAPaintingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    private long getTankCapacity() {
        if (LoadConfig.MA_MORE_CAPACITY_CONFIG.moreCapacityMode.get()) {
            return switch (tier) {
                case ETERNAL -> LoadConfig.MA_MORE_CAPACITY_CONFIG.eternalPainting.get();
                case NEURAL -> LoadConfig.MA_MORE_CAPACITY_CONFIG.neuralPainting.get();
                case FLARE -> LoadConfig.MA_MORE_CAPACITY_CONFIG.flarePainting.get();
                case PRISMATIC -> LoadConfig.MA_MORE_CAPACITY_CONFIG.prismaticPainting.get();
            };
        } else {
