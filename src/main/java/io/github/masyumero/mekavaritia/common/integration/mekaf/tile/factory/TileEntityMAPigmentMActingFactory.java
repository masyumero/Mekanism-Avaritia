...
import io.github.masyumero.mekavaritia.common.integration.mekaf.tile.factory.base.TileEntityMAItemToPigmentFactory;
...
public class TileEntityMAPigmentMActingFactory extends TileEntityMAItemToPigmentFactory<ItemStackToPigmentRecipe> implements ItemRecipeLookupHandler<ItemStackToPigmentRecipe> {
    ...
    public TileEntityMAPigmentMActingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
