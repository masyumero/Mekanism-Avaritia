...
public class TileEntityMAWashingFactory extends TileEntityMASlurryToSlurryFactory<FluidSlurryToSlurryRecipe> implements FluidChemicalRecipeLookupHandler<Slurry, SlurryStack, FluidSlurryToSlurryRecipe>, IHasDumpButton {
    ...
    public TileEntityMAWashingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    private int getTankCapacity() {
        if (LoadConfig.MA_MORE_CAPACITY_CONFIG.moreCapacityMode.get()) {
            return switch (tier) {
                case ETERNAL -> LoadConfig.MA_MORE_CAPACITY_CONFIG.eternalWashingFluidInput.get();
                case NEURAL -> LoadConfig.MA_MORE_CAPACITY_CONFIG.neuralWashingFluidInput.get();
                case FLARE -> LoadConfig.MA_MORE_CAPACITY_CONFIG.flareWashingFluidInput.get();
                case PRISMATIC -> LoadConfig.MA_MORE_CAPACITY_CONFIG.prismaticWashingFluidInput.get();
            };
        } else {
