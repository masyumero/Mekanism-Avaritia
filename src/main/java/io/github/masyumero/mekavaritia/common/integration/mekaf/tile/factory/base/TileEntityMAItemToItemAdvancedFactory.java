...
import io.github.masyumero.mekavaritia.common.integration.mekaf.inventory.slot.MAAdvancedFactoryOutputInventorySlot;
...
public abstract class TileEntityMAItemToItemAdvancedFactory<RECIPE extends MekanismRecipe> extends TileEntityMAAdvancedFactoryBase<RECIPE> {
    ...
    protected TileEntityMAItemToItemAdvancedFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state, List<RecipeError> errorTypes, Set<RecipeError> globalErrorTypes) {
    ...
    protected void addSlots(InventorySlotHelper builder, IContentsListener listener, IContentsListener updateSortingListener) {
        ...
        for (int i = 0; i < tier.processes; i++) {
            MAAdvancedFactoryOutputInventorySlot outputSlot = MAAdvancedFactoryOutputInventorySlot.at(this, updateSortingListener, getXPos(i), 57);
            // Note: As we are an item factory that has comparator's based on items we can just use the monitor as a
            // listener directly
            MAAdvancedFactoryInputInventorySlot inputSlot = MAAdvancedFactoryInputInventorySlot.create(this, i, outputSlot, recipeCacheLookupMonitors[i], getXPos(i), 13);
            int index = i;
    ...
    public record ItemToItemProcessInfo(int process, @NotNull MAAdvancedFactoryInputInventorySlot inputSlot,
