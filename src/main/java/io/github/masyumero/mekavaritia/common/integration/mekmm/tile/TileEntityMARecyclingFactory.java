...
public class TileEntityMARecyclingFactory extends TileEntityMAMoreMachineFactory<RecyclerRecipe> implements ItemRecipeLookupHandler<RecyclerRecipe> {
    ...
    public TileEntityMARecyclingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
