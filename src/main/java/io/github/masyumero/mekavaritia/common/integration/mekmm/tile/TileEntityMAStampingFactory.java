...
public class TileEntityMAStampingFactory extends TileEntityMAItemToItemFactory<StamperRecipe> implements DoubleItemRecipeLookupHandler<StamperRecipe> {
    ...
    public TileEntityMAStampingFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    @Nullable
    @Override
    protected InputInventorySlot getMASlot() {
        return moldSlot;
    }
