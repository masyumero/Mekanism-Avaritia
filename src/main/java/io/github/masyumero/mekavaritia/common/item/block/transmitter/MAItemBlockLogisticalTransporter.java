...
import io.github.masyumero.mekavaritia.common.block.transmitter.MABlockLogisticalTransporter;
...
public class MAItemBlockLogisticalTransporter extends ItemBlockMekanism<MABlockLogisticalTransporter> {

    public MAItemBlockLogisticalTransporter(MABlockLogisticalTransporter block) {
    ...
    public void appendHoverText(@Nonnull ItemStack stack, Level world, @Nonnull List<Component> tooltip, @Nonnull TooltipFlag flag) {
        if (MekKeyHandler.isKeyPressed(MekanismKeyHandler.detailsKey)) {
            ...
            tooltip.add(MekanismLang.SPEED.translateColored(EnumColor.INDIGO, EnumColor.GRAY, MATPTier.getSpeed(this.getTier()) / 5));
            tooltip.add(MekanismLang.PUMP_RATE.translateColored(EnumColor.INDIGO, EnumColor.GRAY, MATPTier.getPullAmount(this.getTier()) * 2));
