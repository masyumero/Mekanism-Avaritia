...
import io.github.masyumero.mekavaritia.common.block.transmitter.MABlockPressurizedTube;
import io.github.masyumero.mekavaritia.common.tier.transmitter.MATTier;
...
public class MAItemBlockPressurizedTube extends ItemBlockMekanism<MABlockPressurizedTube> {

    public MAItemBlockPressurizedTube(MABlockPressurizedTube block) {
    ...
    public void appendHoverText(@NotNull ItemStack stack, Level world, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        if (MekKeyHandler.isKeyPressed(MekanismKeyHandler.detailsKey)) {
            ...
            tooltip.add(MekanismLang.CAPACITY_MB_PER_TICK.translateColored(EnumColor.INDIGO, EnumColor.GRAY, TextUtils.format(MATTier.getTubeCapacity(this.getTier()))));
            tooltip.add(MekanismLang.PUMP_RATE_MB.translateColored(EnumColor.INDIGO, EnumColor.GRAY, TextUtils.format(MATTier.getTubePullAmount(this.getTier()))));
