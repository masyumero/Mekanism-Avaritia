...
public abstract class MAAbstractInputRecipeCache<RECIPE extends MekanismRecipe> implements IInputRecipeCache {
    protected final MARecipeType<RECIPE, ?> recipeType;
    protected boolean initialized;

    protected MAAbstractInputRecipeCache(MARecipeType<RECIPE, ?> recipeType) {
