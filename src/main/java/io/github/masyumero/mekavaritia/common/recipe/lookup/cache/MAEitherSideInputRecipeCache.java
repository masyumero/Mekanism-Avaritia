...
public abstract class MAEitherSideInputRecipeCache<INPUT, INGREDIENT extends InputIngredient<INPUT>, RECIPE extends MekanismRecipe & BiPredicate<INPUT, INPUT>,
        CACHE extends IInputCache<INPUT, INGREDIENT, RECIPE>> extends MAAbstractInputRecipeCache<RECIPE> {
    ...
    protected MAEitherSideInputRecipeCache(MARecipeType<RECIPE, ?> recipeType, Function<RECIPE, INGREDIENT> inputAExtractor,
