...
public class TileEntityMetallurgicInfuserMAFactory extends TileEntityItemToItemMAFactory<MetallurgicInfuserRecipe> implements IHasDumpButton,
    ...
    public TileEntityMetallurgicInfuserMAFactory(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
