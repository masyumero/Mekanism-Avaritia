...
public abstract class TileEntityMALogisticalTransporterBase extends TileEntityMATransmitter {

    protected TileEntityMALogisticalTransporterBase(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    public static void tickClient(Level level, BlockPos pos, BlockState state, TileEntityMALogisticalTransporterBase transmitter) {
